      ...
      <div class="row">
         <div class="col-12">
          <?php
            ...
            $idadministrador = filter_var($_GET['idadministrador']);
            $consulta = $conectar->query("SELECT * FROM administrador where idadministrador='$idadministrador'");
            $linha = $consulta->fetch(PDO::FETCH_ASSOC);
          ?>
          <form action="../../php/sistema/editausuarioadm.php" method="post">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label>Senha</label>
                <input type="password" class="form-control" name="senha" value="<?php echo $linha['senha'] ?>"  id="senha" required>
              </div>
            </div>
            <input type="hidden" name="idadministrador" value="<?php echo $linha['idadministrador'] ?>">
