      ...
      <div class="row">
        <div class="col-12">
          <?php
            ...
            $idcategoria = filter_var($_GET['idcategoria']);
            $consulta = $conectar->query("SELECT * FROM categoria where idcategoria='$idcategoria'");
            $linha = $consulta->fetch(PDO::FETCH_ASSOC);
          ?>
          <form action="../../php/sistema/editaCategoria.php" method="post">
            <!-- area de campos do form -->
            <hr />
            <div class="row">
              <div class="form-group col-md-8">
                <label>Nome Categoria</label>
                <input type="text" class="form-control" name="nomecategoria" id="nomecategoria" value="<?php echo $linha['nomecategoria'] ?>" required>
              </div>
              <div class="form-group col-md-4">
                <label>Código</label>
                <input type="number" class="form-control" name="categoria" id="categoria" value="<?php echo $linha['idcategoria'] ?>" disabled ="disabled">
                <input type="hidden" class="form-control" name="idcategoria" id="idcategoria" value="<?php echo $linha['idcategoria'] ?>">
              </div>
            </div>
            <div class="row">
