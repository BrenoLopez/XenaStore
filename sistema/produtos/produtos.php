      ...
      <div class="row">
        <div class="col-12">
          <div id="top" class="row">
              ...
              <div class="col-md-2">
                  <a href="produtoscadastro.php" class="btn btn-success btn-sm">Novo Produto</a>
              </div>
              <div class="col-md-2">
                  <a href="categorias.php" class="btn btn-primary btn-sm">Categorias</a>
              </div>
          </div>
            ...
            <div class="table-responsive col-md-12">
              ...
              <?php
                ...
                try{
                  ...
                  $consulta = $conectar->query("SELECT * FROM items i join categoria c on i.idcategoria=c.idcategoria join imagem g on  i.iditem = g.iditem order by i.iditem ASC ");
                  ...
                  <table class='table table-striped' cellspacing='0' cellpadding='0'>
                    ...
                    while($linha=$consulta->fetch(PDO::FETCH_ASSOC)){
                      ...
                      <tr>
                            ...
                            <?php echo  "<td>R$ $linha[precovenda]</td>";?>
                            <?php echo  "<td>R$ $linha[precocompra]</td>";?>
                            <?php echo  "<td>$categoria</td>";?>
                            <?php echo  "<td class='actions'>
                                <a class='btn btn-warning btn-sm' href='produtosedicao.php?iditem=$linha[iditem]&nomeProduto=$linha[nome]'>Editar</a>
                                <a class='btn btn-danger btn-sm' href='../../php/sistema/excluiItem.php?iditem=$linha[iditem]'>Excluir</a>
                              </td>";
                      } 
