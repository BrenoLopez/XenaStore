...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <form action="../../php/sistema/cadastraCategoria.php" method="post">
            <!-- area de campos do form -->
            <hr />
            <div class="row">
              <div class="form-group col-md-8">
                <label>Nome Categoria</label>
                <input type="text" class="form-control" name="nomecategoria" id="nomecategoria" required>
              </div>
              <div class="form-group col-md-4">
                <label>Código</label>
                <input type="number" class="form-control" name="idcategoria" id="idcategoria" required>
              </div>
            </div>
            <div class="row">
