...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form action="../../php/sistema/cadastraItem.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="precocompra" id="precocompra" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Valor Venda</label>
                            <input type="text" class="form-control" name="precovenda" id="precovenda" required>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="idcategoria" required>"
                                ...
                                while($linha=$consulta->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <option value="<?php echo $idcategoria ?>"><?php echo $linha['nomecategoria'];?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
