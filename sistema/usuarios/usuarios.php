      ...
      <div class="row">
        <div class="col-12">
          <div id="top" class="row">
              ...
              <div class="col-md-2">
                  <a href="usuariosadmcadastro.php" class="btn btn-success btn-sm">Cadastrar</a>
              </div>
          </div>
              ...
              <table class='table table-striped' cellspacing='0' cellpadding='0'>                                    
                ...
                <tbody>
                  <?php while($linha=$consulta->fetch(PDO::FETCH_ASSOC)){ ?>
                     <tr>
                        <?php echo "<td>$linha[login]</td>"; ?>
                        <?php echo "<td class='actions'>
                                      <a class='btn btn-warning btn-sm' href='usuariosadmedicao.php?idadministrador=$linha[idadministrador]'>Editar</a>
                                      <a class='btn btn-danger btn-sm' href='../../php/sistema/excluiusuarioadm.php?idadministrador=$linha[idadministrador]'>Excluir</a>
                                    </td>"; ?>
                      </tr>
                  <?php } 
