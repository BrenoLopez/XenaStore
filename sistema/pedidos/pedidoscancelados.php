        ...
        <div class="row">
            <div class="col-12">
                <div id="top" class="row">
                    <div class="col-md-10">
                        <h2>Listagem de pedidos cancelados</h2>
                    </div>
                </div>
                <?php
                include ("../../php/conexao.php");
                $consulta = $conectar->prepare("select * from pedidos p join clientes c on p.idcliente = c.idcliente join itemspedidos i on i.idpedido = p.idpedido where situacao like '%c%'");
                $consulta->execute();
                ?>
