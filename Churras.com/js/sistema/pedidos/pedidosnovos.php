        ...
        <div class="row">
            <div class="col-12">
                <div id="top" class="row">
                    <div class="col-md-10">
                        <h2>Listagem de novos pedidos</h2>
                    </div>
                </div>
        <!-- fazer select dos pedidos junção com os intens junção com os clientes e buscar pela situação de entrega igual a n -->
                <!-- tabela dos pedidos novos-->

                <?php
                include ("../../php/conexao.php");
                $consulta = $conectar->prepare("select * from pedidos p join clientes c on p.idcliente = c.idcliente join itemspedidos i on i.idpedido = p.idpedido where situacao like '%n%'");
                $consulta->execute();
                ?>
