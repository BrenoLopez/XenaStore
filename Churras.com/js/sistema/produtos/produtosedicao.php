    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          ...
          ?>
          <form action="../../php/sistema/editaItem.php" method="post">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="nomeproduto" id="nomeproduto" value="<?php echo $linha['nomeproduto'] ?>" required>
              </div>
              <div class="form-group col-md-3">
                <label>Valor Compra</label>
                <input type="text" class="form-control" name="precocompra" id="precocompra" value="<?php echo $linha['precocompra'] ?>" required>
              </div>
              <div class="form-group col-md-3">
                <label>Valor Venda</label>
                <input type="text" class="form-control" name="precovenda" id="precovenda" value="<?php echo $linha['precovenda'] ?>" required>
              </div>
            </div>
            <div class="row">
                 <div class="form-group col-md-12">
                <label for="descricao">Descrição</label>
                <input type="text" class="form-control" name="descricao" id="descricao" value="<?php echo $linha['descricao'] ?>" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label for="imagem">Imagem</label>
                <input type="file" class="form-group" name="imagem"/>
              </div>
              <div class="form-group col-md-6">
