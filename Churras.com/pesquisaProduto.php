...
$consulta = $conectar->query("SELECT * FROM items i join imagem g ON i.iditem=g.iditem WHERE i.nomeproduto LIKE '%$pesquisa%'");
...
<div class="form-control col-sm" style="padding-top:45px;">
    <form class="form-inline" action="pesquisaProduto.php" method="post" style="padding-top:10px">
        ...
        <a class="btn btn-primary dimensoesBotoes" href="produtos.php" >Voltar</a>
    </form>
</div>
