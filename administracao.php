      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pedidos">
          ...
          <ul class="sidenav-second-level collapse" id="collapsePedidos">
            <li>
              <a href="sistema/pedidos/pedidosnovos.php">Novos</a>
            </li>
            <li>
              <a href="sistema/pedidos/pedidosentregues.php">Entregues</a>
            </li>
            <li>
              <a href="sistema/pedidos/pedidoscancelados.php">Cancelados</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Produtos">
          <a class="nav-link" href="sistema/produtos/produtos.php">
            <i class="fa fa-fw fa-cubes"></i>
            <span class="nav-link-text">Produtos</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Usuários">
          <a class="nav-link" href="sistema/usuarios/usuarios.php">
            <i class="fa fa-fw fa-user-circle-o"></i>
            <span class="nav-link-text">Usuários</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Clientes">
          <a class="nav-link" href="sistema/clientes/clientes.php">
            <i class="fa fa-fw fa-users"></i>
            <span class="nav-link-text">Clientes</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Profile">
          <a class="nav-link" href="sistema/profile/profile.php">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="sistema/sessionend.php">Logout</a>
          </div>
        </div>
      </div>
    </div>
