    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('../img-fixa/canecas/caneca1.jpg')">
          ...
          <div class="carousel-item" style="background-image: url('../img-fixa/canecas/caneca2.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Second Slide</h3>
          ...
          <div class="carousel-item" style="background-image: url('../img-fixa/canecas/caneca4.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Third Slide</h3>
