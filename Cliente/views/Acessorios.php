...
$MenuRodape->setAcessorios("active");
$MenuRodape->menu();
$slides->setImg1('../img-fixa/acessorios/acessorios1.jpg');
$slides->setImg2('../img-fixa/acessorios/acessorios3.jpg');
$slides->setImg3('../img-fixa/acessorios/acessorios2.jpg');
$slides->codSlide();
?>
...
$prod= new Produto();
$prod= $prod->ReadProduto('Acessorios');
?>
<!-- Page Content -->
<div class="container">
    <h1 class="my-4">Acessórios</h1>
    <hr>
