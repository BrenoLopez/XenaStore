    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('../img-fixa/posters/poster1.png')">
          ...
          <div class="carousel-item" style="background-image: url('../img-fixa/posters/poster3.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Second Slide</h3>
              <p>descrição.</p>
            </div>
          ...
          <div class="carousel-item" style="background-image: url('../img-fixa/posters/poster2.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Third Slide</h3>
              <p>descrição.</p>
            </div>
