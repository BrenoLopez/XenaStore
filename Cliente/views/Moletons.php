...
$MenuRodape->setMoletons("active");
$MenuRodape->menu();
$slides->setImg1('../img-fixa/moletons/moletons.jpg');
$slides->setImg2('../img-fixa/moletons/moletons3.jpg');
$slides->setImg3('../img-fixa/moletons/moletons4.jpg');
$slides->codSlide();
?>
...
$prod= new Produto();
$prod= $prod->ReadProduto('Moletons');
?>
<!-- Page Content -->
<div class="container">
