    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-sm-6 mb-3">
        <div class="card text-white bg-primary o-hidden h-100">
           <a class="card-footer text-white clearfix small z-1" href="add_func.php">
          <div class="card-body">
            <div class="card-body-icon">
              <i class="fa fa-fw fa-user"></i>
            </div>
           <h3> <div class="mr-5">Cadastrar Funcionários</div> </h3>
          </div>
          </a>
        </div>
      </div>
       ...
       <div class="col-xl-5 col-sm-6 mb-3">
        <div class="card text-white bg-warning o-hidden h-100">
          ...
          <div class="card-body">
           ...
           <h3> <div class="mr-5">Listar Funcionarios</div> </h3>
          </div>
          </a>
        </div>
      </div>
