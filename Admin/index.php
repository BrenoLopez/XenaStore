...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand " href="index.php"><img src="../Cliente/img-fixa/logo.png" width="200px" height="80px"></a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="views/pedidos/listar_pedidos_novos.php">Novos</a>
            </li>
            <li>
              <a href="views/pedidos/listar_pedidos_entregues.php">Entregues</a>
            </li>
            <li>
              <a href="views/pedidos/listar_pedidos_cancelados.php">Cancelados</a>
            </li>
          </ul>
        </li>
